...
const sectionRoutes: SectionRoute[] = [
  ...
  { sectionId: "financial", paths: ["/billing", "/invoice-report", "/client-revenue-report", "/financials/revenue", "/financials/profitability", "/expense-management", "/expense-approval", "/approvals/time", "/reimbursement-batches", "/contractor-invoices", "/vendor-invoices", "/contractor-payments", "/rates"] },
