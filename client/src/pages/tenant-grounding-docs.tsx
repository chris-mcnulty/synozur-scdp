...
import type { GroundingDocument } from "@shared/schema";
import { GROUNDING_DOC_CATEGORY_LABELS, groundingDocCategoryEnum } from "@shared/schema";

type GroundingDocCategory = keyof typeof GROUNDING_DOC_CATEGORY_LABELS;
...
export default function TenantGroundingDocs() {
  ...
  const { data: documents, isLoading } = useQuery<GroundingDocument[]>({
    queryKey: ["/api/grounding-documents", "?scope=tenant"],
  });
  ...
  const createMutation = useMutation({
    mutationFn: async (data: GroundingDocFormData) => {
      const payload = { ...data, tenantId: "current" };
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex items-center justify-between rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/20 p-3">
              <div className="space-y-0.5">
                <FormLabel>Tenant Background Document</FormLabel>
                <FormDescription>When enabled, this document's content will be automatically included in ALL AI interactions for your tenant. Use this for company-wide context like brand guidelines, policies, or key information that should always inform AI responses.</FormDescription>
              </div>
              <FormControl>
                <Switch checked={field.value} onCheckedChange={field.onChange} />
              </FormControl>
        ...
        <div className="p-6">
          <Card>
            <CardContent className="p-6">
              <p className="text-muted-foreground">Access Denied. You do not have permission to access this page.</p>
            </CardContent>
          </Card>
        </div>
      </Layout>
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2">
              ...
              Tenant AI Grounding Documents
            </h1>
            <p className="text-muted-foreground mt-1">Manage AI knowledge documents specific to your organization. These enhance AI-generated content for your team.</p>
          </div>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">Create your first document to enhance AI-generated content for your team.</p>
