...
- **Comprehensive Test Coverage** — automated test suites for auth, scopes, routes, and webhook delivery (Tasks #142, #127)
...
- New tables for Galaxy: `galaxy_apps`, `galaxy_tokens`, `galaxy_webhook_deliveries`, plus auth-code and refresh-token storage
...
- Updated user guide and admin guide for Notifications, Multi-Currency Estimates, Time Grid 2.0, Estimate Version History, Galaxy Client Portal, and Payment Milestone Billing Automation
