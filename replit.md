...
- **Salaried Resource Handling**: Users can be marked as "salaried" individually or via their role's "always salaried" setting. Salaried resources' time is not counted as direct project cost in margin calculations for estimates, time entries, and financial reports. This allows principals and other salaried team members to log time without impacting project profitability metrics.
