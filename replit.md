...
5. **Remove Datadog dd-trace after trial (March 2026)** -- 14-day trial of Datadog LLM Observability added Feb 20, 2026. When trial expires: uninstall `dd-trace` package, remove env vars `DD_LLMOBS_ENABLED`, `DD_LLMOBS_ML_APP`, `DD_API_KEY`, and `NODE_OPTIONS`. App name: `constellation`.