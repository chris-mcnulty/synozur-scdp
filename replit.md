...
3. **Viva Goals Integration Catalog** -- Reference list of former Viva Goals integrations to potentially support or migrate. These were the integrations available in Microsoft Viva Goals before retirement:
   - **In-boundary Microsoft 365**: Excel Online (Data), Planner (Data), Teams (Collaboration)
   - **Cross-boundary Microsoft**: Azure DevOps (Data), Azure Data Explorer (Data), Dynamics (Data), MS SQL (Data), Power BI (Data), Project for the Web (Data)
   - **Third-party Data**: Amazon Redshift, Asana, BigQuery, Box, Domo, Favro, GitHub, GitLab, Google Sheets, HubSpot, Jira (Cloud/Server/Data Center), Looker, Mode, Monday.com, MySQL, PostgreSQL, ProjectPlace, Salesforce, Smartsheet, Snowflake, Tableau, Trello, Zendesk
   - **Third-party Collaboration**: Slack