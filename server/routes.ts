...
export async function registerRoutes(app: Express): Promise<void> {
  ...
  // File storage instances used by remaining routes (SOW uploads, expense attachments)
  ...
  // Schema used by pending receipt status update (also defined in sharepoint-containers module)
